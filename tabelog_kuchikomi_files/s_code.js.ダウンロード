...
function s_doPlugins(s) {
	...
	s.eVar19= s.getMonthlyRoyality(s.rylConf.hitVal);

	//category_royality
	s.rylConf= (function() {
	  var conf = new Object();
	  conf.chkVal = s.server;
	  conf.rlist = {
	    "tabelog.com":"tabelog",
	    "u.tabelog.com":"u",
	    "owner.tabelog.com":"owner",
	    "ssl.tabelog.com":"ssl",
	    "o.tabelog.com":"o",
	    "yoyaku.tabelog.com":"yoyaku",
	    "c.tabelog.com":"c",
	    "user-help.tabelog.com":"user-help",
	    "r.tabelog.com":"r",
	    "camera.tabelog.com":"camera"
	  }
	  if (conf.chkVal) {
            if (conf.rlist[conf.chkVal]){
	      conf.hitVal = conf.rlist[conf.chkVal];
	...
	s.eVar20= s.getMonthlyRoyality(s.rylConf.hitVal);

	s.eVar61=s.currentYear + "/" + s.currentM + "/" + s.currentD + " " + s.currentH + ":" + s.currentm + ":" + s.currentS;
	s.prop63=s.eVar63="D=s_vi";
	s.prop71="20220819_PC";
